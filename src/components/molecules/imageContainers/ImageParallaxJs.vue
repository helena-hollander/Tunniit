...
<template>
    <header class="h-[200vh] overflow-x-hidden relative"> <!-- overflow-x-hidden og relative, sikrer, at jeg ikke får en horizontal scrollbar -->
        ...
        <!-- <Image imagePath="/images/smoke2.png" :ref="el => scrollers.push(el)" data-initial-y="-10px" data-rate="0.1"></Image> -->
        <Image src="/images/smoke2.png" :initialY="'-10px'" :rate="0.7" :initialX="'-30px'" :rateX="10"></Image>
